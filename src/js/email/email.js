...
/*var FOLDER_TYPE_INBOX = '收件箱';
var FOLDER_TYPE_SENT = '发件箱';
var FOLDER_TYPE_DRAFTS = '草稿箱';
var FOLDER_TYPE_TRASH = '垃圾邮件';
var FOLDER_TYPE_FLAGGED = 'Flagged';*/
...
Email.prototype.decryptBody = function(options) {
    ...
    function setBody(root) {
        ...
        console.log('email.js 668');
        //console.log(root);
        //console.log('email.js 670');
...
Email.prototype._sendGeneric = function(options, mailer) {
    ...
    return new Promise(function(resolve) {
        ...
        // send the email
        console.log('email.js 769');
        //console.log(options);
        console.log('email.js 771');
...
Email.prototype.refreshOutbox = function() {
    ...
    return this._localListMessages({
        ...
        //console.log('email.js 827  outbox');
        //console.log(outbox);
...
Email.prototype.onConnect = function(imap) {
    ...
    return self._auth.getCredentials().then(function(credentials) {
        ...
        self._account.folders.forEach(function(folder) {
            ...
            //console.log('email.js 924');
            //console.log(uids);
            //console.log(folder);
            //console.log(lastUid);
            //console.log(mailboxCache[folder.path]);
        });
        //console.log(self._account.folders);
    ...
    function onConnectionError(error) {
        //console.log('IMAP connection error, disconnected. Reason: ' + error.message + (error.stack ? ('\n' + error.stack) : ''));

        if (!self.isOnline()) {
            return;
        }

        //console.log('Attempting reconnect in ' + config.reconnectInterval / 1000 + ' seconds.');

        setTimeout(function() {
            //console.log('Reconnecting the IMAP stack');
...
Email.prototype._fetchMessages = function(options) {
    ...
    return new Promise(function(resolve) {
        ...
        console.log('email.js 1447  folder');
        //console.log(folder);
        updateUnreadCount(folder); // update the unread count
        return messages;
    });
...
Email.prototype._extractBody = function(message) {
    ...
    console.log('email.js 1618');
    //console.log(message);
    //console.log('email.js 1601');
    return new Promise(function(resolve) {
        resolve();
...
Email.prototype._uploadToSent = function(options) {
    var self = this;
    console.log('email.js 1717');
    //console.log(options);
    //console.log('email.js 1663');
    self.busy();
    return new Promise(function(resolve) {
        resolve();
...
function updateUnreadCount(folder, countAllMessages) {
    //console.log('email.js 1786');
    //console.log(folder);
    //console.log(countAllMessages);
