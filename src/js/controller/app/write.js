...
var WriteCtrl = function($scope, $window, $filter, $q, appConfig, auth, keychain, pgp, email, outbox, dialog, axe, status, invitation) {
    ...
    function fillFields(re, replyAll, forward) {
        ...
        $scope.writerTitle = (forward) ? '转发' : '回复';
        ...
        if (forward) {
            ...
            console.log('app write.js 157');
            //console.log($scope.attachments);
            //console.log('app write.js 159');
        }
    ...
    $scope.sendToOutbox = function() {
        ...
        console.log('write.js 413');
        //console.log($scope.attachments);
        //console.log('write.js 415');
        if ($scope.inReplyTo) {
        ...
        return $q(function(resolve) {
            ...
            console.log('write.js 441');
            //console.log(message);
            //console.log('write.js 443');
